...
export const addToCompare = async (hostelId) => {
  try {
    const res = await API.post("/users/compare", { hostelId });
    return res.data;
  } catch (error) {
...
export const removeFromCompare = async (hostelId) => {
  try {
    const res = await API.delete(`/users/compare/${hostelId}`);
    return res.data;
  } catch (error) {
...
export const getCompareList = async () => {
  try {
    ...
    return res.data;  // { success, compareList, count }
  } catch (error) {
...
export const getComparison = async () => {
  try {
    const res = await API.get("/users/compare/details");
    return res.data; // { success, comparison }
  } catch (error) {
...
export const clearCompareList = async () => {
  try {
    const res = await API.delete("/users/compare");
    return res.data;
  } catch (error) {
